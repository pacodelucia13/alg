package stdlib; /*************************************************************************
 *  Compilation:  javac stdlib.Out.java
 *  Execution:    java stdlib.Out
 *
...
public class Out {
    ...
    // assume language = English, country = US for consistency with stdlib.In
    private static final Locale US_LOCALE = new Locale("en", "US");

    private PrintWriter out;

   /**
     * Create an stdlib.Out object using an OutputStream.
     */
   ...
   /**
     * Create an stdlib.Out object using standard output.
     */
    public Out() { this(System.out); }

   /**
     * Create an stdlib.Out object using a Socket.
     */
   ...
   /**
     * Create an stdlib.Out object using a file specified by the given name.
     */
    public Out(String s) {
        try {
