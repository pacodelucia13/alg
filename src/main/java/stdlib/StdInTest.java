package stdlib; /**
 * Test client for StdIn and stdlib.In.
 **/
...
public class StdInTest {
    ...
    /**
     * stdlib.In the two methods below, each Object[] of "steps" is a length-2
    ...
    public static void main(String[] args) {
        ...
        if (testStdIn) 
            ...
            StdOut.println("Note: StdIn.resync is private, only stdlib.In will be tested.");
