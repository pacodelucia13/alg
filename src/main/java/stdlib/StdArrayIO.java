package stdlib;
/*************************************************************************
 *  Compilation:  javac stdlib.StdArrayIO.java
 *  Execution:    java stdlib.StdArrayIO < input.txt
 *
 ...
 *    1 1 1
 *
 *  % cat tinyDouble1D.txt tinyDouble2D.txt tinyBoolean2D.txt | java stdlib.StdArrayIO
 *  4
