package stdlib; /*************************************************************************
 *  Compilation:  javac stdlib.In.java
 *  Execution:    java stdlib.In   (basic test --- see source for required files)
 *
...
public final class In {
    ...
    /*** begin: section (1 of 2) of code duplicated from stdlib.In to StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from stdlib.In to StdIn */
   ...
   /**
    ...
    /*** begin: section (2 of 2) of code duplicated from stdlib.In to StdIn,
   ...
   /**
    ...
    public char readChar() {
        ...
        assert (ch.length() == 1) : "Internal (Std)stdlib.In.readChar() error!"
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from stdlib.In to StdIn */
   ...
   /**
     ...
     * <tt>new stdlib.In(filename)</tt>.{@link #readAllInts()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new stdlib.In(filename)</tt>.{@link #readAllDoubles()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new stdlib.In(filename)</tt>.{@link #readAllStrings()}
     */
